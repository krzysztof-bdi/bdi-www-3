...
export async function POST(req: Request){
  try {
    ...
    const payload = {
      Name: data.Name, Email: data.Email, Law_Firm: data.Law_Firm?? null, Message: data.Message?? null,
      Source: 'LP PRAWO', Intent_ID: 'LP_PRAWNICY', Verification_Status: 'pending',
