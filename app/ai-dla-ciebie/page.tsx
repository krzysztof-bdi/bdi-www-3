...
  const [state, setState] = useState({ name:'', email:'', message:'', agree:false, hp:'' })
...
        Certyfikowane szkolenia AI z dofinansowaniem dla mieszkańców Warszawy. Krótko, praktycznie, z KPI.
      </p>
...
          <h2>Co zyskasz</h2>
          <ul>
            <li>Portfolio mini-projektów w 30 dni</li>
            <li>Automatyzacja pracy i mierzalne KPI</li>
            <li>Wsparcie w pozyskaniu finansowania</li>
          </ul>
        </div>
