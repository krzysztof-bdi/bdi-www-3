...
export default function KontaktPage(){
  const [state, setState] = useState({ name:'', email:'', message:'', agree:false })
  ...
  async function submit(e: React.FormEvent){
    ...
    try{
      const res = await fetch('/api/contact', {
        ...
        body: JSON.stringify({ Name: state.name, Email: state.email, Message: state.message, Source: 'Kontakt WWW' })
      })
