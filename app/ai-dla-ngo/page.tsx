...
        Certyfikowane szkolenia AI dla organizacji pozarządowych. Dostępne dofinansowanie (Warszawa).
      </p>
...
          <h2>Co zyskujesz</h2>
          <ul>
            <li>Automatyzacja wniosków i raportów</li>
            <li>Szablony i dobre praktyki (NGO)</li>
            <li>Wsparcie w procesie dofinansowania</li>
          </ul>
          <p className="text-sm text-text-secondary">Masz pytania? <Link className="underline" href="/kontakt">Napisz do nas</Link>.</p>
        </div>
...
          </div>
          <div>
            <label className="block mb-1 text-sm text-text-secondary">Organizacja</label>
            <input className="w-full p-3 rounded-xl bg-background-secondary/60 border border-white/10"
                   value={state.org} onChange={e=>setState(s=>({...s, org:e.target.value}))}/>
          </div>
          <div>
